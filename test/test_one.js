...
var producer = function(payload, callback){
    var task = {
        'taskUrl':'http://wxstage.sephora.cn/index.php?g=Interface&m=Message&a=tplSend&token=ychodn1421823030', //任务执行的url
...
if (!module.parent) {
    ...
    producer(payload, function(err, result){
